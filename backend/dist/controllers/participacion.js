...
exports.consultarUsuariosPorProyecto = exports.consultarProyectosPorUsuario = exports.postular = exports.consultarParticipaciones = exports.delatePart = exports.updatePart = exports.consultPart = exports.createPart = exports.consultarPart = void 0;
            ...
            include: [
                {
                    ...
                    as: "proyecto",
                    where: {
                        fechafin: { [sequelize_1.Op.gte]: hoy },
                    },
                },
            ],
        });
        ...
        res.status(200).json({
            ...
            usuarios: participaciones.map((p) => {
                ...
                return ({
                    ...
                    correo: (_c = p.usuario) === null || _c === void 0 ? void 0 : _c.correo,
                    telefono: (_d = p.usuario) === null || _d === void 0 ? void 0 : _d.telefono,
                });
            }),
        });
    }
